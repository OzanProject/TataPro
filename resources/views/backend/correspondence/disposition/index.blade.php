...
@push('css')
    <style>
        ...
        /* Hover Row Effect */
        .table-disposition tbody tr:hover {
                ...
                <div class="card-body p-0">
                    <div class="tab-content" id="dispositionTabContent">
                        ...
                        <div class="tab-pane fade show active" id="tab-inbox" role="tabpanel">
                                            ...
                                            <tr>
                                                <td class="pl-4">
                                                    <div class="d-flex align-items-center">
                                                        <div class="bg-light-primary rounded-circle mr-3 d-flex align-items-center justify-content-center shadow-xs"
                                                ...
                                                <td>
                                                    <div class="mail-subject text-truncate" style="max-width: 280px;"
                                                        title="{{ $disp->incoming_mail->subject }}">
                                                        {{ $disp->incoming_mail->subject ?? '-' }}
                                                    </div>
                                                    <span
                                                        class="text-primary font-weight-bold small">#{{ $disp->incoming_mail->mail_number ?? '-' }}</span>
                                                </td>
                                                <td>
                                                    <div class="instruction-highlight rounded">
                                                        <span
                                                            class="d-block font-weight-bold text-info small mb-1">{{ $disp->instruction }}</span>
                                                        <div class="small text-muted italic">{{ Str::limit($disp->note, 60) }}
                                                        </div>
                                                    </div>
                                                </td>
                            ...
                            <div class="mt-3 px-3">
                                {{ $inbox->appends(['outbox_page' => $outbox->currentPage()])->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="tab-outbox" role="tabpanel">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <span class="badge badge-{{ $disp->status == 'completed' ? 'success' : 'outline-warning' }} border px-2 py-1">
                                                                    ...
                                                                    <a href="{{ route('incoming.show', $disp->incoming_mail_id) }}" class="btn bt
                                             n                              -white btn-sm text-info border-right" title="Detail"><i class="fas fa-eye"></i></a>
                            ...
                            <div class="mt-3 px-3">
                                {{ $outbox->appends(['inbox_page' => $inbox->currentPage()])->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
